...
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAF.sl C:\STAF_ISMP_InputFiles\build\lib\base\hpux\*.*
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAFDSLS.sl C:\STAF_ISMP_InputFiles\build\lib\base\hpux\*.*
...
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAFLog.sl C:\STAF_ISMP_InputFiles\build\lib-log\hpux\*.*

REM Monitor Service hpux files
md C:\STAF_ISMP_InputFiles\build\lib-mon\hpux
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAFMon.sl C:\STAF_ISMP_InputFiles\build\lib-mon\hpux\*.*

REM Respool service hpux files
md C:\STAF_ISMP_InputFiles\build\lib-pool\hpux
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAFPool.sl C:\STAF_ISMP_InputFiles\build\lib-pool\hpux\*.*

REM Zip service hpux files
md C:\STAF_ISMP_InputFiles\build\lib-zip\hpux
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAFZip.sl C:\STAF_ISMP_InputFiles\build\lib-zip\hpux\*.*
copy C:\STAF_ISMP_InputFiles\hpux\lib\libSTAFZlib.sl C:\STAF_ISMP_InputFiles\build\lib-zip\hpux\*.*
...
copy C:\STAF_ISMP_InputFiles\hpux\lib\libJSTAF.sl C:\STAF_ISMP_InputFiles\build\lib-java\hpux\*.*
copy C:\STAF_ISMP_InputFiles\hpux\lib\libJSTAFSH.sl C:\STAF_ISMP_InputFiles\build\lib-java\hpux\*.*
...
copy C:\STAF_ISMP_OutputFiles\disk1\STAF264-setup-hpux.bin C:\STAF_Installers\hpux\*.*
copy C:\STAF_ISMP_OutputFiles\disk1\STAF264-setup.jar C:\STAF_Installers\hpux\STAF264-setup-hpux.jar
