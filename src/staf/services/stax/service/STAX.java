...
{
    static final String fVersion = "3.5.8";
    ...
    public STAFResult init(STAFServiceInterfaceLevel30.InitInfo info)
    {
        ...
        try
        {
            ...
            fListParser.addOptionNeed("TOTAL", "JOBS");
            ...
            String setOptions = "CLEARLOGS LOGTCELAPSEDTIME " +
                ...
                "EVENTGENERATION FILECACHING MAXFILECACHESIZE " +
...
// End DTD chunk..............................................................
     ...
     */ 
    private void logToJVMLog(String message)
    {
        STAXTimestamp currTimestamp = new STAXTimestamp();

        System.out.println(currTimestamp.getTimestampString() + " " + message);
    }
